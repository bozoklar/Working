...
@CucumberOptions(//It is an annotation that has some special keywords
        features = "src/test/resources/features/trello.feature",//This is the location of feature files, but we provide folder(features)
        glue = "com/test/stepdefinitions",//This is the location of step definitions classes, but we provide folder(step definitions)
